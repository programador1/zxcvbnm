<?php
if (!(strtolower($this->session->userdata('usuario_tipo'))=='archivo')){
...
<a class="dashboard_button button5" href="<?php echo site_url('archivo/buscar_concesionesMineras'); ?>">
    <span class="dashboard_button_heading">Concesiones</span>
    <span>Datos de Concesiones Mineras</span>
</a><!--end dashboard_button-->

<a class="dashboard_button button10" href="<?php echo site_url('archivo/usuario/edit/'.$this->session->userdata('id_usuario')); ?>">
    ...
    <ul class="nav">
        <li><a class="headitem item1" href="#">Principal</a>
            <ul class="opened"><!-- ul items without this class get hiddden by jquery-->
                <li><a href="<?php echo site_url('archivo'); ?>">Inicio</a></li>
<!--               <li><a href="<?php echo site_url('archivo/corregir_datos'); ?>">Corregir fecha resolucion</a></li>-->
                <li><a href="<?php echo site_url('archivo/buscar_concesionesMineras'); ?>">Buscar Concesiones</a></li>
<!--                <li><a href="<?php echo site_url('archivo'); ?>">Ayuda</a></li>-->
            </ul>
        </li>

        <li><a class="headitem item4" href="#">Cuenta de Usuario</a>
            <ul>
                <li><a href="<?php echo site_url('archivo/usuario/edit/'.$this->session->userdata('id_usuario')); ?>">Cambiar contrase&ntilde;a</a></li>
<!--                <li><a href="<?php echo site_url('archivo/mensaje'); ?>">Mensajes</a></li>-->
            </ul>
        </li>
    </ul><!--end subnav-->
