<?php
if (!(strtolower($this->session->userdata('usuario_tipo'))=='administrativo')){
...
<a class="dashboard_button button5" href="<?php echo site_url('administrativo/informacion_concesion'); ?>">
    <span class="dashboard_button_heading">Concesiones</span>
    <span>Buscar Concesiones Mineras</span>
</a><!--end dashboard_button-->

<a class="dashboard_button button10" href="<?php echo site_url('administrativo/usuario/edit/'.$this->session->userdata('id_usuario')); ?>">
    ...
    <ul class="nav">
        <li><a class="headitem item1" href="#">Principal</a>
            <ul class="opened"><!-- ul items without this class get hiddden by jquery-->
                <li><a href="<?php echo site_url('administrativo'); ?>">Inicio</a></li>
                <li><a href="<?php echo site_url('administrativo/informacion_concesion'); ?>">Buscar Concesiones Mineras</a></li>
<!--                <li><a href="<?php echo site_url('administrativo'); ?>">Ayuda</a></li>-->
            </ul>
        </li>

        <li><a class="headitem item4" href="#">Cuenta de Usuario</a>
            <ul>
                <li><a href="<?php echo site_url('administrativo/usuario/edit/'.$this->session->userdata('id_usuario')); ?>">Cambiar contrase&ntilde;a</a></li>
<!--                <li><a href="<?php echo site_url('administrativo/mensaje'); ?>">Mensajes</a></li>-->
            </ul>
        </li>
    </ul><!--end subnav-->
