...
class Director extends CI_Controller {
    ...
    function _vista_principal($output = null) {
        $this->load->view('index_director.php', $output);
    }
   ...
   function informacion_concesion() {
        ...
        $crud->add_action('Ver mas Informacion', base_url('estilo/images/mas_informacion.png'), 'director/informacion_patentes');
        $crud->unset_add()
             ->unset_edit()
             ->unset_delete()
             ->unset_print()
    ...
    function informacion_patentes($id_concesion_minera) {
        ...
        $output->output = $this->load->view('vista_pestana.php',$enviarContenido, TRUE);
        $output->titulo = 'BUSCAR CONCESIONES MINERAS';
        $this->_vista_principal($output);
    }
